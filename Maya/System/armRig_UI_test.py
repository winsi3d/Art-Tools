...
import Maya.Modules.Layout.WW_Arm_Lyt_test as WW_Arm_Lyt
reload(WW_Arm_Lyt)
import Maya.Modules.Rig.WW_Arm_Rig_test as WW_Arm_Rig
reload(WW_Arm_Rig)
import Maya.Modules.Controls.WW_Arm_Controls_test as WW_Arm_Controls
...
class armRig_UI:
    ...
    def createArmRig(self, FK_Arm_Joints, IK_Arm_Joints, IK_handle_list, *args):        
        WW_Arm_Rig_test.Arm_Rig()
        print WW_Arm_Rig.DESCRIPTION

    def createArmControls(self, *args): 
        WW_Arm_Controls_test.Arm_Controls()
